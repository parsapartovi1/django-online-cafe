...
class ProductCreateView(View):
    ...
    def post(self, request):
        ...
        try:
            ...
            return render(request, 'serveHub/success.html', {'message': 'Product created successfully!'})
...
class ProductUpdateView(View):
    def get(self, request, id):
        ...
        categories = Category.objects.all()
        return render(request, 'serveHub/product_form.html', {
            'object': product,
    ...
    def post(self, request, id):
        ...
        try:
            ...
            return render(request, 'serveHub/success.html', {'message': 'Product updated successfully!'})
        except Exception as e:
...
class ProductDeleteView(View):
    def get(self, request, id):
        product = get_object_or_404(Product, id=id)
        return render(request, 'serveHub/product_confirm_delete.html', {'object': product})
    ...
    def post(self, request, id):
        ...
        return render(request, 'serveHub/success.html', {'message': 'Product deleted successfully!'})
...
class TableCreateView(View):
    ...
    def post(self, request):
        ...
        try:
            ...
            return render(request, 'serveHub/success.html', {'message': 'Table created successfully!'})
        except Exception as e:
...
class TableUpdateView(View):
    ...
    def post(self, request, id):
        ...
        try:
            ...
            return render(request, 'serveHub/success.html', {'message': 'Table updated successfully!'})
        except Exception as e:
